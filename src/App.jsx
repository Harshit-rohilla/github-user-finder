...
function App(){
  const{user,setUser,repo,setRepo,followers,setFollowers,userInfo,setUserInfo,loading,setLoading,fourRepo,setFourRepo,valueIn, setValueIn}=useContext(GithubContext)
